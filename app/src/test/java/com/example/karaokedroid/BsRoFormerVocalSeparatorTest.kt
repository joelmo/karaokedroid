...
class BsRoFormerVocalSeparatorTest {
    ...
    @Test
    fun testBsRoFormerVocalSeparatorCorrectness() {
        ...
        val outputDir = tempFolder.newFolder("bs_roformer_out")
        val updates = mutableListOf<BsRoFormerVocalSeparator.ProgressUpdate>()

        val separationResult = BsRoFormerVocalSeparator.separateWithBsRoFormer(inputFile, outputDir) { progress ->
        ...
        // Ensure we received progress updates and logs from the BS-RoFormer model
